...
- are graphical models that represent probabilistic releationships between variables using a directed acyclic graph (DAG). They are widely used in AI and decision-making to handle uncertainty by updating beliefs based on new evidence
